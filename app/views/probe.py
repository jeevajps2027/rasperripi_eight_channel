...
def probe(request):
    from app.models import probe_calibrations,comport_settings
    if request.method == 'POST':
        ...
        probe.low_ref = a_values
        probe.low_count = a1_values
        probe.high_ref = b_values
        probe.high_count = b1_values
        probe.coefficent = e_values
...
# In your view:
        ...
        settings_json = json.dumps(settings_list)
         ...
         # Debug print to verify the JSON content
