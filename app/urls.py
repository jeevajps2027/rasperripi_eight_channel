...
from .views import home,index,comport,probe,trace,parameter,master,measurebox,measurement,backup,open_rustdesk
...
urlpatterns = [
    ...
    path('open_rustdesk/', open_rustdesk, name='open_rustdesk'),
    ]
